(function exposeUiI18n(root, factory) {
  ...
  const messages = Object.freeze({
    "zh-hans": Object.freeze({
      ...
      filterStatusError: "暂时无法读取 Netflix 字幕资料，已保留所有影片",
    ...
    "zh-hant": Object.freeze({
      ...
      filterStatusError: "暫時無法讀取 Netflix 字幕資料，已保留所有影片",
    ...
    en: Object.freeze({
      ...
      filterStatusError: "Subtitle data is temporarily unavailable; all titles remain visible",
